...
public class MoodPlaylistService extends TemplateService {
    ...
    private final String FCT = "getfrommood";
    private final String QUERY_RESULTS_NUMBER = "resultsnumber";
    private final String QUERY_TRACK_VALENCE = "trackvalence";
    private final String QUERY_TRACK_AROUSAL = "trackarousal";
    private final String QUERY_YEAR_MAX = "yearmax";
    private final String QUERY_YEAR_MIN = "yearmin";
    private final String QUERY_BEFORE_1950 = "before1950";
    private final String QUERY_DATE_50 = "date50";
    private final String QUERY_DATE_60 = "date60";
    private final String QUERY_DATE_70 = "date70";
    private final String QUERY_DATE_80 = "date80";
    private final String QUERY_DATE_90 = "date90";
    private final String QUERY_DATE_00 = "date00";
    private final String QUERY_DATE_10 = "date10";
    private final String QUERY_POPULARITY_MAX = "popularitymax";
    private final String QUERY_POPULARITY_MIN = "popularitymin";
    private final String QUERY_GENRE_NO = "genreNo";
